...
function statusVariant(status: FragranceStatus): React.ComponentProps<typeof Badge>["variant"] {
    switch (status) {
      ...
      case "WANT_TO_BUY":
      case "WANT_TO_SMELL": return "wishlist";
            ...
            {[1, 2, 3, 4, 5].map((s) => (
                          <button
                                      ...
                                      style={{
                                                    ...
                                                    fontSize: "16px",
                                                    lineHeight: 1,
                                                    color: filled >= s ? "var(--color-accent)" : "var(--color-sand-light)",
    ...
    return (
          <div
                ...
                <input
                          ...
                          className="placeholder:text-[var(--color-sand)] focus:border-[var(--color-accent)]"
                        />
          </div>div>
        );
}
...
function CollectionInner() {
    ...
    useEffect(() => {
          setPage(1);
    }, [search, sort, statusFilter, ratingFilter, accordFilter, houseFilter]);
                                  ...
                                  <div
                                    ...
                                    {/* Row 1 */}
                                              <div
                                                ...
                                                {/* Search input */}
                                                            <div
                                                                              style={{ position: "relative", display: "flex", alignItems: "center", width: "320px" }}
                                    ...
                                    {filtersOpen && (
                                                              <div
                                                                              ...
                                                                              <div style={{ width: "160px" }}>
                                                                                                <Select options={STATUS_FILTER_OPTIONS} value={statusFilter} onChange={setStatusFilter} placeholder="Status" />
                                                                              </div>div>
                                                                              <div style={{ width: "160px" }}>
                                                                                      ...
                                                                                      <div className="hidden md:block">
                                                                                                    ...
                                                                                                    return (
                                                                                                                              <tr
                                                                                                                                                          ...
                                                                                                                                                          style={{
                                                                                                                                                                                        height: "64px",
                                                                                                                                                                                        background: isEven ? "var(--color-cream)" : "var(--color-cream-dark)",
                                                                                                                                                                                        borderBottom: "1px solid var(--color-sand-light)",
                                                                                                                                                                                        cursor: "pointer",
                                                                                                                                                                                        transition: "background 100ms",
                                                                                                                                                            }}
                                                                                                                                                          className="hover:bg-[rgba(200,184,154,0.25)]!"
                                                                                                                                                        >
                                                                                                                                {/* FRAGRANCE */}
